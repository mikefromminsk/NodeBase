...
public class Base64
{
    ...
    /**
     * Encode a String using com.example.myapplication4.app.Base64 using the default platform encoding
     **/
...
/*
    public static final void main(String[] args)
    {
        if (args.length != 1)
        {
            System.out.println("Usage: com.example.myapplication4.app.Base64 string");
            System.exit(0);
        }
        try
        {
            String e = com.example.myapplication4.app.Base64.encode(args[0].getBytes());
            String d = new String(com.example.myapplication4.app.Base64.decode(e));
